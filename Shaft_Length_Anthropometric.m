classdef Shaft_Length_Anthropometric
    ...
    methods 
        function obj = Shaft_Length_Anthropometric(patientHeight, diameterHipTorsionSpring, ...
            ...
            PlantarCamZ3 = (.7/178)*patientHeight; % the distance to the first step up (bearing) after the circlip 
            PlantarCamZ4 = (1.2/178)*patientHeight; % the distance to the second step up after the bearing
            PlantarCamZ5 = (3.2/178)*patientHeight; % the distance to the edge of the cam
            PlantarCamZ6 = (3.9/178)*patientHeight; % the distance to the end of the cam
            PlantarCamZ7 = (4.2/178)*patientHeight; % the distance to the end of the shaft

            PlantarCamDp1 = (0.6/178)*patientHeight; % the diamater of the shaft up to the circlip
            PlantarCamDp2 = (0.5/178)*patientHeight; % the diameter of the shaft at the circlip
            PlantarCamDp3 = (0.6/178)*patientHeight; % the diameter of the shaft after the circlip/diameter of inside of bearing
            PlantarCamDp4 = (0.8/178)*patientHeight; % the diameter of the shaft up to the cam
            PlantarCamDp5 = (0.6/178)*patientHeight; % the diameter of the shaft after the cam
