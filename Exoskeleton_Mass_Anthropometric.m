...
%                 vBelt = 0.5*pi*((rBelt + tBelt).^2 - rBelt.^2) * hBelt
% 
%                 mBelt = vBelt * obj.DensityAl; % the total mass of the the belt 
% 
%                 % Dimensions of bearing case
...
%                 Vshaft1 = pi*(Rbearing1In.^2)*Lshaft1; % volume of hip shaft 1
% 
%                 Mbearing1Case = Vbearing1Case * obj.DensityAl; % the mass of the bearing case
%                 Mshaft1 = Vshaft1 * obj.DensityAl; % mass of the hip bearing shaft
% 
%                 % Dimensions of hip to bearing case mount....mount1 is where the screws are
%                 % and mount 2 extends to bearing case
...
%                 Vmount = (Lmount1 * Wmount1 * Hmount1) + (Lmount2 * Wmount2 * Hmount2); % total volume of the belt to bearing case mount
% 
%                 Mmount = Vmount * obj.DensityAl; % mass of the mount
% 
%                 %2 DOF joint which connects hip bearing case to hip disc case
...
% 
%                 MdiscCase = VdiscCase * obj.DensityHDPE; % mass of the case surrounding the discs
%                 Mdisc = Vdisc * obj.DensityAl; % mass of 1 of the discs
%                 MdiscConnecter = VdiscConnecter * obj.DensityAl; % the mass of the piece that connects from the 2DOF joint to the lateral disc
%                 Mshaft = Vshaft * obj.DensityAl; % mass of the shaft which supports both hip discs
% 
%                 % The dimensions for the thigh strap which connects the upper leg to the device
...
%                 VthighStrapPadding = 0.5*pi*(RthighStrapCaseIn.^2 - Rthigh.^2) * HthighStrapCase; % volume of the padding in between the thigh and case
% 
%                 MthighStrapCaseSupport = VthighStrapCaseSupport * obj.DensityAl; % the mass of the support which connects the thigh strap to the leg
%                 MthighStrapCase = VthighStrapCase * obj.DensityHDPE; % the mass of the case which wraps around the users thigh
%                 MthighStrapPadding = VthighStrapPadding * obj.DensityFoam; % the mass of the foam padding which cushions the thigh against the case
% 
%                 % the dimensions for the calf strap which connects the lower leg to the device
...
%                 VcalfStrapPadding = 0.5*pi*(RcalfStrapCaseIn.^2 - Rcalf.^2) * HcalfStrapCase; % volume of the padding in between the calf and case
% 
%                 McalfStrapCaseSupport = VcalfStrapCaseSupport * obj.DensityAl; % the mass of the support which connects the calf strap to the leg
%                 McalfStrapCase = VcalfStrapCase * obj.DensityHDPE; % the mass of the case which wraps around the users calf
%                 McalfStrapPadding = VcalfStrapPadding * obj.DensityFoam; % the mass of the foam padding which cushions the calf against the case
% 
%                 % the dimensions for the dorsiflexion spring mechanism and bar connecting
%                 % the hip disc to the top of the 4 bar linkage 
...
%                 MtopBar = VtopBar * obj.DensityAl; % the mass of the top bar which connects the medial disc to link 3 of the 4 bar knee
%                 MdorsiSpringCase = VdorsiSpringCase * obj.DensityHDPE; % mass of the case surrounding the dorsiflexion spring
% 
% 
%                 % the dimensions of the 4 bar linkage 
...
%                 vLinks = (Llink1 + Llink2 + Llink3 + Llink4) * tLinks * wLinks; % the combined volume of all of the links
% 
%                 mLinks = vLinks * obj.DensityAl; % total mass of the links used to create 4 bar pulley
% 
%                 % the dimensions of the universal joint at the ankle 
...
%                 MbotBar = VbotBar * obj.DensityAl; % the mass of the bot bar which connects the universal ankle joint to link 1 of the 4 bar knee
% 
%                 % the dimensions of the ankle bar and foot bar
