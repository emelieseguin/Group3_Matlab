...
% dorsiflexion torsional cam dimensions  
    ...
    obj.vDorsiCamDimensions = 2*pi*(OuterDorsiCamRadius^2)*DorsiCamCutDepth + ...
...
% 4-bar bolt dimensions
    ...
    obj.vCalfCase = (pi/2)*(calfOuterCaseDiameter^2-calfInnerCaseDiameter^2)*calfCaseHeight + ...
    ...
    obj.vThighCase = (pi/2)*((thighOuterCaseDiameter/2)^2-(thighInnerCaseDiameter/2)^2)*thighCaseHeight + ...
    ...
    obj.vThighPadding = (pi/2)*((thighOuterPaddingDiameter/2)^2-(thighInnerPaddingDiameter/2^2))*thighPaddingHeight - ...
