function DorsiflexionCamBearingCalcs(fRadial, patientHeight)
...
%% Parametrized Geometry
    ...
    innerSmallRingDiameter = (0.009658/1.78)*patientHeight;
    innerLargeRingDiameter = (0.0152885/1.78)*patientHeight;
    bearingLength = (0.004966/1.78)*patientHeight;
    radialClearance = (0.0000075/1.78)*patientHeight;
    shaftRadius = (0.004829/1.78)*patientHeight;
